 ...
 *      DEFINES
 *********************/
#if defined(CONFIG_SPI_HOST_MAX)
#define SPI_HOST_MAX (CONFIG_SPI_HOST_MAX)
#endif
#if defined(CONFIG_LV_LVGL_H_INCLUDE_SIMPLE)
#define LV_LVGL_H_INCLUDE_SIMPLE (CONFIG_LV_LVGL_H_INCLUDE_SIMPLE)
#endif
